...
#
package ElasticEmail::Object::ContactActivity;
...
__PACKAGE__->method_documentation({
    ...
    'last_ip' => {
        datatype => 'string',
        base_name => 'LastIP',
        description => 'IP from which this contact opened or clicked their email last time',
        format => '',
        read_only => '',
            },
    'error_code' => {
    ...
    'friendly_error_message' => {
        datatype => 'string',
        base_name => 'FriendlyErrorMessage',
...
__PACKAGE__->openapi_types( {
    ...
    'total_failed' => 'int',
    'last_sent' => 'DATE_TIME',
    'last_opened' => 'DATE_TIME',
    'last_clicked' => 'DATE_TIME',
    'last_failed' => 'DATE_TIME',
    'last_ip' => 'string',
    'error_code' => 'int',
