...
#
package ElasticEmail::Object::SubaccountSettingsInfoPayload;
...
__PACKAGE__->class_documentation({description => 'SubAccount settings',
...
__PACKAGE__->method_documentation({
    'email' => {
        datatype => 'SubaccountEmailSettingsPayload',
        base_name => 'Email',
