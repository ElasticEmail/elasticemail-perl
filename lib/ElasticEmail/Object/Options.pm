...
#
package ElasticEmail::Object::Options;
...
__PACKAGE__->class_documentation({description => 'E-mail configuration',
                                  class => 'Options',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'encoding' => {
        datatype => 'EncodingType',
        base_name => 'Encoding',
        description => '0 for None, 1 for Raw7Bit, 2 for Raw8Bit, 3 for QuotedPrintable, 4 for Base64 (Default), 5 for Uue note that you can also provide the text version such as \&quot;Raw7Bit\&quot; for value 1. NOTE: Base64 or QuotedPrintable is recommended if you are validating your domain(s) with DKIM.',
        format => '',
        read_only => '',
            },
    'track_opens' => {
