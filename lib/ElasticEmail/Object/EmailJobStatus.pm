...
#
package ElasticEmail::Object::EmailJobStatus;
...
__PACKAGE__->method_documentation({
    ...
    'failed' => {
        datatype => 'ARRAY[EmailJobFailedStatus]',
        base_name => 'Failed',
        description => '',
        format => '',
        read_only => '',
