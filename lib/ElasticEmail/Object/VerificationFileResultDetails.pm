...
#
package ElasticEmail::Object::VerificationFileResultDetails;
...
__PACKAGE__->class_documentation({description => 'Detailed verification file result info',
...
__PACKAGE__->method_documentation({
    'verification_result' => {
        datatype => 'ARRAY[EmailValidationResult]',
    ...
    'verification_status' => {
        ...
        description => 'In what state does this verification result currently is',
        format => '',
        read_only => '',
            },
    'file_upload_result' => {
        ...
        description => 'How many emails were detected in the file for verification',
        format => '',
        read_only => '',
            },
    'date_added' => {
