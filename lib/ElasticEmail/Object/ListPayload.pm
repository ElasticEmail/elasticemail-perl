...
#
package ElasticEmail::Object::ListPayload;
...
__PACKAGE__->method_documentation({
    ...
    'emails' => {
        ...
        base_name => 'Emails',
        description => 'Comma delimited list of existing contact emails that should be added to this list. Leave empty for all contacts',
        format => '',
        read_only => '',
            },
});
