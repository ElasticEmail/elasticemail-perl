...
#
package ElasticEmail::Object::Campaign;
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[CampaignTemplate]',
        base_name => 'Content',
        description => 'Campaign&#39;s email content. Provide multiple items to send an A/X Split Campaign',
        format => '',
        read_only => '',
            },
    'name' => {
    ...
    'recipients' => {
        ...
        description => 'Recipients this campaign should be sent to',
        format => '',
        read_only => '',
            },
    'options' => {
        ...
        base_name => 'Options',
        description => 'Campaign sending options',
        format => '',
        read_only => '',
            },
});
