...
#
package ElasticEmail::Object::BodyPart;
...
__PACKAGE__->class_documentation({description => 'Email body part with user-provided MIME type (text/html, text/plain, etc)',
                                  class => 'BodyPart',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'content_type' => {
        datatype => 'BodyContentType',
        base_name => 'ContentType',
        description => 'Type of the body part',
        format => '',
        read_only => '',
            },
    'content' => {
