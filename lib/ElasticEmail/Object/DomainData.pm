...
#
package ElasticEmail::Object::DomainData;
...
__PACKAGE__->class_documentation({description => 'Domain data, with information about domain records.',
                                  class => 'DomainData',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'validation_log' => {
        datatype => 'string',
        base_name => 'ValidationLog',
        description => 'Domain validation results - when domain has been running through validation process',
        format => '',
        read_only => '',
            },
    'domain' => {
    ...
    'is_rewrite_domain_valid' => {
        datatype => 'boolean',
        base_name => 'IsRewriteDomainValid',
    ...
    'tracking_status' => {
        datatype => 'TrackingValidationStatus',
        base_name => 'TrackingStatus',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'tracking_type_user_request' => {
        datatype => 'TrackingType',
        base_name => 'TrackingTypeUserRequest',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'custom_bounces_domain' => {
        datatype => 'string',
        base_name => 'CustomBouncesDomain',
        description => '',
        format => '',
        read_only => '',
            },
    'is_custom_bounces_domain_default' => {
        datatype => 'boolean',
        base_name => 'IsCustomBouncesDomainDefault',
        description => '',
        format => '',
        read_only => '',
            },
