...
#
package ElasticEmail::Object::CampaignOptions;
...
__PACKAGE__->class_documentation({description => 'Different send options for a Campaign',
...
__PACKAGE__->method_documentation({
    'delivery_optimization' => {
        datatype => 'DeliveryOptimizationType',
        base_name => 'DeliveryOptimization',
        description => 'How to order email delivery - by recipients&#39; engagement score or by the time they open the most of the emails that were sent to them',
        format => '',
        read_only => '',
            },
    'track_opens' => {
        datatype => 'boolean',
        base_name => 'TrackOpens',
    ...
    'schedule_for' => {
        datatype => 'DateTime',
        base_name => 'ScheduleFor',
        description => 'Date when this Campaign is scheduled to be sent on',
        format => '',
        read_only => '',
            },
    'split_options' => {
        datatype => 'SplitOptions',
        base_name => 'SplitOptions',
        description => 'Optional options for A/X split campaigns. Will be ignored if only one template content was provided',
        format => '',
        read_only => '',
            },
});
