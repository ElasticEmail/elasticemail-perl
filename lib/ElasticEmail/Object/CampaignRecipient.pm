...
#
package ElasticEmail::Object::CampaignRecipient;
...
__PACKAGE__->class_documentation({description => 'A set of lists and segments names to read recipients from',
