...
#
package ElasticEmail::Object::NewSmtpCredentials;
...
__PACKAGE__->class_documentation({description => 'Newly generated SMTP Credentials with Token',
...
__PACKAGE__->method_documentation({
    ...
    'access_level' => {
        ...
        description => 'Access level of this Smtp Credential.',
        format => '',
        read_only => '',
            },
    'name' => {
