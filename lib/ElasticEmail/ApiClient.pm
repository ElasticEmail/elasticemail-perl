...
#
package ElasticEmail::ApiClient;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'ElasticEmail::Configuration' ) {
        $config = $_[0];
    } else {
        $config = ElasticEmail::Configuration->new(@_);
    }
...
sub update_params_for_auth {
    ...
    foreach my $auth (@$auth_settings) {
        ...
        if (!defined($auth)) {
            ...
            my $api_key = $self->get_api_key_with_prefix('X-ElasticEmail-ApiKey');
            if ($api_key) {
