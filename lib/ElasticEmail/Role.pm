...
has _cfg => ( is => 'ro',
              isa => 'ElasticEmail::Configuration',
              default => sub { ElasticEmail::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Elastic Email REST API',
                          app_version => '4.0.0',
...
sub _build_af {
    ...
    return ElasticEmail::ApiFactory->new(%args);
}
...
=head2 Elastic Email REST API version: 4.0.0
