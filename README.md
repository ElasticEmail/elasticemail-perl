...
Function ||
------------ | ------------- 
[addCampaign](examples/addCampaign.pl) | [readme](examples/addCampaign.md)
[addBulkContacts](examples/addBulkContacts.pl) | [readme](examples/addBulkContacts.md)
[addList](examples/addList.pl) | [readme](examples/addList.md)
[addSingleContact](examples/addSingleContact.pl) | [readme](examples/addSingleContact.md)
[addTemplate](examples/addTemplate.pl) | [readme](examples/addTemplate.md)
[deleteCampaign](examples/deleteCampaign.pl) | [readme](examples/deleteCampaign.md)
[deleteContacts](examples/deleteContacts.pl) | [readme](examples/deleteContacts.md)
[deleteList](examples/deleteList.pl) | [readme](examples/deleteList.md)
[deleteTemplate](examples/deleteTemplate.pl) | [readme](examples/deleteTemplate.md)
[exportContacts](examples/exportContacts.pl) | [readme](examples/exportContacts.md)
[loadCampaigns](examples/loadCampaigns.pl) | [readme](examples/loadCampaigns.md)
[loadCampaignsStats](examples/loadCampaignsStats.pl) | [readme](examples/loadCampaignsStats.md)
[loadChannelsStats](examples/loadChannelsStats.pl) | [readme](examples/loadChannelsStats.md)
[loadList](examples/loadList.pl) | [readme](examples/loadList.md)
[loadStatistics](examples/loadStatistics.pl) | [readme](examples/loadStatistics.md)
[loadTemplate](examples/loadTemplate.pl) | [readme](examples/loadTemplate.md)
[sendBulkEmails](examples/sendBulkEmails.pl) | [readme](examples/sendBulkEmails.md)
[sendTransactionalEmails](examples/sendTransactionalEmails.pl) | [readme](examples/sendTransactionalEmails.md)
[updateCampaign](examples/updateCampaign.pl) | [readme](examples/updateCampaign.md)
